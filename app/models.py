...
class Message(db.Model):
    ...
    recipient_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=True) # For direct messages
    room_id = db.Column(db.Integer, db.ForeignKey('chat_room.id'), nullable=True) # For group messages
